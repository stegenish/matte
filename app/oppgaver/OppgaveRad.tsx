...
import { Strategikort } from "@/src/komponenter/Strategikort";
...
export function OppgaveRad({
  ...
  const strategi = riktig === false ? strategiForOppgave(oppgave) : null;
  return (
    <div className="flex flex-col gap-1">
      ...
      {strategi && <Strategikort strategi={strategi} />}
    </div>
  );
}

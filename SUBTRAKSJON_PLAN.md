...
- 2026-09-09: Oppfølging etter visuell tilbakemelding: hovedstykket, faseforklaringen og ballene er samlet i én arbeidsflate i stedet for separate desktop-kolonner. Den inverse addisjonen er redusert til en liten «Sjekk med pluss»-linje under arbeidsflaten. Komponenttesten beskytter hierarkiet, og live QA ved 320 px viser ingen horisontal overflow.
- 2026-09-09: Fersk-kontekst-gjennomgangen fant én semantisk detalj: den sekundære addisjonen hadde navn på en vanlig paragraf. Den er nå en gyldig, navngitt `note`. Sluttverifisering bestått med 233 tester, TypeScript, ESLint og produksjonsbuild.
- 2026-09-09: Eksempeltempoet er senket fra 450 til 750 ms per ball etter brukertilbakemelding. En fake-timer-test beskytter grensen direkte: tom rute ved 749 ms og første ball ved 750 ms.
- 2026-09-09: Fersk-kontekst-gjennomgangen var ren etter at tempoasserten ble gjort presis. Full suite, TypeScript, ESLint og build er grønne.
